...
export const state = {
  ...
  gdIntensity: 0.5, gdBeams: 0.5, gdCloud: 0.5, gdPulse: 0.4, gdSpeed: 2, gdSoft: 0.5, gdBlur: 0.25,  // godray settings (gdSpeed=anim rate, gdSoft=edge feather, gdBlur=gaussian)
  ...
  rectW: 0.15, rectH: 0.15, rectReach: 0.6,   // box reveal (68): seed rect half-w/h + outward travel
